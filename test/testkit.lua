...
local function FINISH()
	...
	print(string.format("%d/%d test cases passed in %.3f ms.", passed_cases, total_cases, duration * 1e3))

	local fails = total_cases - passed_cases

	print(
		(fails > 0 and color.red_highlight or color.green_highlight)(
...
function START(iter)
	...
	bench.iterations = n
	bench.memory_start = collectgarbage("count")
